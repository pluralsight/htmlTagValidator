...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c42 = peg$otherExpectation("Tag that can optionally have a closing tag"),
      peg$c43 = function(otn, sp, c, stn) {return isClosingTagOptional(otn.name) && otn.name === stn.name},
      peg$c44 = function(otn, sp, c) {
          debugger
      ...
      peg$c45 = peg$otherExpectation("Tag"),
      peg$c46 = function(otn, sp, c, ctn) { return !isSelfClosing(otn.name) /* && !isClosingTagOptional(otn.name)*/ /* || otn.name === ctn.name */; },
      ...
      peg$c49 = peg$otherExpectation("Self-closing Tag"),
      peg$c50 = function(ot) {
          var attrs;
          if (!ot.back) {
      ...
      peg$c51 = peg$otherExpectation("Opening Tag"),
      peg$c52 = function(t, attrs, cl, e) {
          return {
            'name': t,
            'attributes': _u.collapse(attrs),
            'closing': cl,
      ...
      peg$c53 = peg$otherExpectation("Closing Tag"),
      peg$c54 = function(o, t, c) {
          return {
            'name': t,
            'front': o !== null,
            'back': c !== null
      ...
      peg$c55 = peg$otherExpectation("Tag Name"),
      peg$c56 = /^[A-Za-z]/,
      peg$c57 = peg$classExpectation([["A", "Z"], ["a", "z"]], false, false),
      peg$c58 = /^[0-9A-Z_a-z\-]/,
      peg$c59 = peg$classExpectation([["0", "9"], ["A", "Z"], "_", ["a", "z"], "-"], false, false),
      peg$c60 = function(tns, tne) { 
          var tn = [tns].concat(tne);
          return _u.option('settings/preserveCase', null, codex) ? _u.textNode(tn) : _u.tagify(tn);
        },
      peg$c61 = peg$otherExpectation("Attribute"),
      peg$c62 = function(ta, t) {
          return {
            'name': ta,
            'value': t
          };
        },
      peg$c63 = peg$otherExpectation("Attribute Name"),
      peg$c64 = /^[^=\/\\ <>]/,
      peg$c65 = peg$classExpectation(["=", "/", "\\", " ", "<", ">"], true, false),
      peg$c66 = function(n) { return n.length; },
      peg$c67 = function(n) {
          return _u.option('settings/preserveCase', null, codex) ? _u.textNode(n) : _u.tagify(n);
        },
      peg$c68 = peg$otherExpectation("Attribute Value (Double Quoted)"),
      peg$c69 = "\"",
      peg$c70 = peg$literalExpectation("\"", false),
      peg$c71 = /^[^"]/,
      peg$c72 = peg$classExpectation(["\""], true, false),
      peg$c73 = function(v) { return { 'value': _u.textNode(v), 'unquoted': false }; },
      peg$c74 = /^[s]/,
      peg$c75 = peg$classExpectation(["s"], false, false),
      peg$c76 = function(v) { return { 'value': '', 'unquoted': false }; },
      peg$c77 = peg$otherExpectation("Attribute Value (Single Quoted)"),
      peg$c78 = "'",
      peg$c79 = peg$literalExpectation("'", false),
      peg$c80 = /^[^']/,
      peg$c81 = peg$classExpectation(["'"], true, false),
      peg$c82 = peg$otherExpectation("Attribute Value (Unquoted)"),
      peg$c83 = /^[^ >]/,
      peg$c84 = peg$classExpectation([" ", ">"], true, false),
      peg$c85 = function(v) { return { 'value': _u.textNode(v), 'unquoted': true }; },
      peg$c86 = peg$otherExpectation("Attribute Value"),
      peg$c87 = peg$otherExpectation("Attribute Assignment"),
      peg$c88 = "=",
      ...
      peg$c91 = peg$otherExpectation("Text Node"),
      peg$c92 = function(tn) {
        return {
          'type': 'text',
          'contents': tn
      ...
      peg$c93 = peg$otherExpectation("Block Comment"),
      peg$c94 = function(com, cc) {
          if (cc === null) {
            return error('Found an open HTML comment tag without a closing tag');
          }
          return com;
        },
      peg$c95 = peg$otherExpectation("Comment Start"),
      peg$c96 = "<!--",
      peg$c97 = peg$literalExpectation("<!--", false),
      peg$c98 = peg$otherExpectation("Comment Close"),
      peg$c99 = "-->",
      peg$c100 = peg$literalExpectation("-->", false),
      peg$c101 = function(cb) {
      ...
      peg$c102 = function(cs) { return _u.textNode(cs);  },
      peg$c103 = function(cons, com, cone) { return cons === null && cone === null; },
      peg$c104 = function(cons, com, cone) {
          var condition = '';
          if (cone === null) {
      ...
      peg$c111 = function(csc) { return _u.tagify(csc); },
      peg$c112 = "endif",
      peg$c113 = peg$literalExpectation("endif", false),
      peg$c114 = "]",
      peg$c115 = peg$literalExpectation("]", false),
      peg$c116 = function() { return true; },
      peg$c117 = /^[^<>]/,
      peg$c118 = peg$classExpectation(["<", ">"], true, false),
      peg$c119 = function(cs) { return _u.textNode(cs); },
      peg$c120 = peg$otherExpectation("Anything"),
      peg$c121 = peg$otherExpectation("Characters"),
      peg$c122 = function(c) { return _u.textNode(c); },
      peg$c123 = peg$otherExpectation("Enforced Whitespace"),
      peg$c124 = /^[ \f\n\r\t\x0B]/,
      peg$c125 = peg$classExpectation([" ", "\f", "\n", "\r", "\t", "\x0B"], false, false),
      peg$c126 = peg$otherExpectation("Optional Whitespace"),
  ...
  function peg$parsetag() {
    ...
    if (s0 === peg$FAILED) {
      ...
      if (s0 === peg$FAILED) {
        ...
        if (s0 === peg$FAILED) {
          s0 = peg$parsetag_optionally_closed();
          if (s0 === peg$FAILED) {
  ...
  function peg$parsetag_optionally_closed() {
    var s0, s1, s2, s3, s4, s5, s6, s7;
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (s2 !== peg$FAILED) {
        ...
        if (s3 !== peg$FAILED) {
          ...
          peg$silentFails++;
          s5 = peg$currPos;
          s6 = peg$parseopen_tag();
          if (s6 !== peg$FAILED) {
            peg$savedPos = peg$currPos;
            s7 = peg$c43(s1, s2, s3, s6);
            if (s7) {
              s7 = void 0;
            } else {
              s7 = peg$FAILED;
