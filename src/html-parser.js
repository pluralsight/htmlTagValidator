...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c3 = peg$otherExpectation("HTML DOCTYPE"),
      peg$c4 = "<!",
      peg$c5 = peg$literalExpectation("<!", false),
      peg$c6 = "<",
      peg$c7 = peg$literalExpectation("<", false),
      peg$c8 = "iframe",
      peg$c9 = peg$literalExpectation("iframe", false),
      ...
      peg$c17 = function(ls, dt, ex) { return _u.tagify(dt) === 'doctype'; },
      peg$c18 = function(ls, dt, ex) {
      ...
      peg$c19 = peg$otherExpectation("Content"),
      peg$c20 = function(c) { return c; },
      peg$c21 = peg$otherExpectation("Node"),
      peg$c22 = peg$otherExpectation("Node Types"),
      peg$c23 = peg$otherExpectation("Comment Node Types"),
      peg$c24 = peg$otherExpectation("HTML Tag"),
      peg$c25 = peg$otherExpectation("IFRAME Element"),
      peg$c26 = function(iot, ic, ict) { return _u.has(['iframe'], iot.name); },
      peg$c27 = function(iot, ic, ict) { return ict === null || iot.name === ict.name; },
      peg$c28 = function(iot, ic, ict) {
          var err;
      ...
      peg$c29 = peg$otherExpectation("Non-parsed Element"),
      peg$c30 = function(sot, sc, sct) { return _u.has(['script', 'style', 'title'], sot.name); },
      peg$c31 = function(sot, sc, sct) {
          var err;
      ...
      peg$c35 = function(st) { return ['script', 'style', 'title', 'iframe'].indexOf(_u.tagify(st)) !== -1; },
      peg$c36 = function(st) { return _u.tagify(st); },
      peg$c37 = "</",
      peg$c38 = peg$literalExpectation("</", false),
      peg$c39 = function(cs) { return _u.scriptify(cs);  },
      peg$c40 = "/",
      ...
      peg$c43 = peg$otherExpectation("Tag"),
      peg$c44 = function(otn, sp, c, ctn) { return !isSelfClosing(otn.name) /* || otn.name === ctn.name */; },
      peg$c45 = function(otn, sp, c, ctn) {
          var err, attrs, parts = [];
          if (!otn.back) {
      ...
      peg$c47 = peg$otherExpectation("Self-closing Tag"),
      peg$c48 = function(ot) {
          var attrs;
          if (!ot.back) {
      ...
      peg$c49 = peg$otherExpectation("Opening Tag"),
      peg$c50 = function(t, attrs, cl, e) {
          return {
            'name': t,
            'attributes': _u.collapse(attrs),
            'closing': cl,
      ...
      peg$c51 = peg$otherExpectation("Closing Tag"),
      peg$c52 = function(o, t, c) {
          return {
            'name': t,
            'front': o !== null,
            'back': c !== null
      ...
      peg$c56 = /^[0-9A-Z_a-z\-]/,
      peg$c57 = peg$classExpectation([["0", "9"], ["A", "Z"], "_", ["a", "z"], "-"], false, false),
      peg$c58 = function(tns, tne) {
          var tn = [tns].concat(tne);
          return _u.option('settings/preserveCase', null, codex) ? _u.textNode(tn) : _u.tagify(tn);
        },
      peg$c59 = peg$otherExpectation("Attribute"),
      peg$c60 = function(ta, t) {
          return {
            'name': ta,
            'value': t
          };
        },
      peg$c61 = peg$otherExpectation("Attribute Name"),
      peg$c62 = /^[^=\/\\ <>]/,
      peg$c63 = peg$classExpectation(["=", "/", "\\", " ", "<", ">"], true, false),
      peg$c64 = function(n) { return n.length; },
      peg$c65 = function(n) {
          return _u.option('settings/preserveCase', null, codex) ? _u.textNode(n) : _u.tagify(n);
        },
      peg$c66 = peg$otherExpectation("Attribute Value (Double Quoted)"),
      peg$c67 = "\"",
      peg$c68 = peg$literalExpectation("\"", false),
      peg$c69 = /^[^"]/,
      peg$c70 = peg$classExpectation(["\""], true, false),
      peg$c71 = function(v) { return { 'value': _u.textNode(v), 'unquoted': false }; },
      peg$c72 = /^[s]/,
      peg$c73 = peg$classExpectation(["s"], false, false),
      peg$c74 = function(v) { return { 'value': '', 'unquoted': false }; },
      peg$c75 = peg$otherExpectation("Attribute Value (Single Quoted)"),
      peg$c76 = "'",
      peg$c77 = peg$literalExpectation("'", false),
      peg$c78 = /^[^']/,
      peg$c79 = peg$classExpectation(["'"], true, false),
      peg$c80 = peg$otherExpectation("Attribute Value (Unquoted)"),
      peg$c81 = /^[^ >]/,
      peg$c82 = peg$classExpectation([" ", ">"], true, false),
      peg$c83 = function(v) { return { 'value': _u.textNode(v), 'unquoted': true }; },
      peg$c84 = peg$otherExpectation("Attribute Value"),
      peg$c85 = peg$otherExpectation("Attribute Assignment"),
      peg$c86 = "=",
      ...
      peg$c89 = peg$otherExpectation("Text Node"),
      peg$c90 = function(tn) {
        return {
          'type': 'text',
          'contents': tn
      ...
      peg$c91 = peg$otherExpectation("PHP Code"),
      peg$c92 = function(com, cc) {
          return com;
        },
      peg$c93 = peg$otherExpectation("PHP start"),
      peg$c94 = "<?php",
      peg$c95 = peg$literalExpectation("<?php", false),
      peg$c96 = "<?",
      peg$c97 = peg$literalExpectation("<?", false),
      peg$c98 = "<?=",
      peg$c99 = peg$literalExpectation("<?=", false),
      peg$c100 = peg$otherExpectation("PHP close"),
      peg$c101 = "?>",
      peg$c102 = peg$literalExpectation("?>", false),
      peg$c103 = function(pb) {
          return {
            'type': 'php',
            'attributes': {},
      ...
      peg$c104 = peg$otherExpectation("Block Comment"),
      peg$c105 = function(com, cc) {
          if (cc === null) {
            return error('Found an open HTML comment tag without a closing tag');
          }
          return com;
        },
      peg$c106 = peg$otherExpectation("Comment Start"),
      peg$c107 = "<!--",
      peg$c108 = peg$literalExpectation("<!--", false),
      peg$c109 = peg$otherExpectation("Comment Close"),
      peg$c110 = "-->",
      peg$c111 = peg$literalExpectation("-->", false),
      peg$c112 = function(cb) {
      ...
      peg$c113 = function(cs) { return _u.textNode(cs);  },
      peg$c114 = function(cons, com, cone) { return cons === null && cone === null; },
      peg$c115 = function(cons, com, cone) {
          var condition = '';
          if (cone === null) {
      ...
      peg$c122 = function(csc) { return _u.tagify(csc); },
      peg$c123 = "endif",
      peg$c124 = peg$literalExpectation("endif", false),
      peg$c125 = "]",
      peg$c126 = peg$literalExpectation("]", false),
      peg$c127 = function() { return true; },
      peg$c128 = /^[^<>]/,
      peg$c129 = peg$classExpectation(["<", ">"], true, false),
      peg$c130 = function(cs) { return _u.textNode(cs); },
      peg$c131 = peg$otherExpectation("Anything"),
      peg$c132 = peg$otherExpectation("Characters"),
      peg$c133 = function(c) { return _u.textNode(c); },
      peg$c134 = peg$otherExpectation("Enforced Whitespace"),
      peg$c135 = /^[ \f\n\r\t\x0B]/,
      peg$c136 = peg$classExpectation([" ", "\f", "\n", "\r", "\t", "\x0B"], false, false),
      peg$c137 = peg$otherExpectation("Optional Whitespace"),
      peg$c138 = peg$otherExpectation("End of File"),
  ...
  function peg$parsephp_start_scan() {
    var s0, s1, s2;
