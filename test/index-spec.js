...
function runTests() {
  ...
  describe('ampersands in attribute values', function () {
    it('unambiguous ampersands', function (done) {
      var resultTree = '{"doctype":null,"document":[{"type":"iframe","attributes":{"src":"https://player.vimeo.com/video/123445777?title=0&byline=0&portrait=0&badge=0","width":"450","height":"253"},"contents":{"doctype":null,"document":[]}}]}';
      tree.equals(resultTree, this, done);
    });

    it('ambiguous ampersands', function (done) {
      tree.error({
