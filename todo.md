...
- [ ] **[0.1.x]** Key areas
  - [ ] **[In Progress]** Validate HTML documents against HTML 5 spec
  - [ ] **[In Progress]** Parsing an HTML document to generate an AST
  - [ ] Create documentation for 0.1.x release
- [ ] **[0.2.x]** Key areas
...
- [ ] **[0.3.x]** Key areas
  - [ ] Allow plugins to extend errors/validations generated by parser
